...
export default function SocialMediaIcons({ className = '', iconSize = 'w-6 h-6' }: SocialMediaIconsProps) {
  const socialLinks = [
    {
      name: 'TikTok',
      url: 'https://www.tiktok.com/@godgpt_',
      icon: (
    ...
    {
      name: 'Instagram',
      url: 'https://www.instagram.com/godgpt._/',
      icon: (
        <svg className={iconSize} fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
    ...
    {
      name: 'YouTube',
      url: 'https://www.youtube.com/@godgptofficial',
      icon: (
        <svg className={iconSize} fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
