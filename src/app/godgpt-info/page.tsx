...
export default function GodGPTInfoPage() {
  return (
    <div className="min-h-screen bg-gradient-to-b from-[#0a0a0a] via-[#1a0a2e] to-[#0a0a0a] relative overflow-hidden">
      ...
      <section className="relative px-5 pt-16 pb-20 md:px-8 md:pt-24 md:pb-32 z-10">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="relative z-10 text-center">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 leading-tight relative overflow-hidden">
              ...
              {/* Single lightbeam that sweeps across the entire title */}
              <span 
            ...
            {/* Trust Indicators */}
            <div className="flex flex-wrap gap-6 justify-center items-center text-sm text-gray-400 mb-6">
            ...
            <div className="flex justify-center">
              <SocialMediaIcons iconSize="w-6 h-6" />
            </div>
          </div>
        </div>
      </section>
      ...
      {/* Discord Community CTA Section */}
      <section className="px-5 py-16 md:px-8 md:py-20 relative z-10">
        <div className="max-w-4xl mx-auto">
          <div className="bg-gradient-to-br from-indigo-900/40 via-purple-900/40 to-pink-900/40 border-2 border-indigo-500/40 rounded-2xl p-8 md:p-12 text-center relative overflow-hidden">
            {/* Background glow */}
            ...
            <div className="relative z-10">
              {/* Discord Icon */}
              <div className="w-16 h-16 rounded-full bg-gradient-to-br from-indigo-500 to-purple-500 flex items-center justify-center mx-auto mb-6 shadow-[0_0_30px_rgba(99,102,241,0.5)]">
              ...
              <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">
                Share Your Reading with Our Community
              </h2>
              <p className="text-lg text-gray-300 mb-6 max-w-2xl mx-auto">
                Got your January theme? Join thousands sharing their 2026 readings, insights, and breakthroughs in our Discord community. Connect, inspire, and grow together.
              </p>
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-3 px-8 h-[56px] rounded-xl bg-gradient-to-r from-indigo-600 to-purple-600 text-white font-bold text-lg transition-all duration-300 active:opacity-80 active:scale-[0.98] hover:shadow-[0_0_40px_rgba(99,102,241,0.6)] shadow-[0_8px_30px_rgba(99,102,241,0.4)] group"
              >
              ...
              <p className="text-sm text-gray-400 mt-4">
                Share insights • Get support • Connect with like-minded souls
              </p>
            </div>
          </div>
        </div>
      ...
      <footer className="px-5 py-8 md:px-8 border-t border-gray-800">
        <div className="max-w-6xl mx-auto">
          <div className="flex flex-col gap-6">
            {/* Social Media Icons */}
            <div className="flex justify-center">
              <SocialMediaIcons iconSize="w-7 h-7" />
            </div>
